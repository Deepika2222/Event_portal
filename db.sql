...
-- INSERT INTO student VALUES(15, 'Rahul Singh', 'ECE', 'rahul@gmail.com', '9988776655');
-- INSERT INTO student VALUES(16, 'Anjali Mehta', 'ISE', 'anjali@gmail.com', '8877665544');
-- INSERT INTO student VALUES(17, 'Karan Kumar', 'CSE', 'karan@gmail.com', '9090909090');
...
-- UPDATE event SET max_seats = 60 WHERE event_id = 1;
-- UPDATE event SET max_seats = 60 WHERE event_id = 3;
-- UPDATE event SET max_seats = 60 WHERE event_id = 4;
-- UPDATE event SET max_seats = 6 WHERE event_id = 5;
-- select * FROM student;
-- select * from event;
-- select * from feedback;
-- select * from feedback;
...
--     COUNT(registration.USN) AS total_registrations
-- FROM event
-- LEFT JOIN registration 
--     ON event.event_id = registration.event_id
-- GROUP BY event.event_id, event.name;

-- SELECT student.name, student.USN
-- FROM registration
-- JOIN student ON registration.USN = student.USN
-- JOIN event ON registration.event_id = event.event_id
-- WHERE event.name = 'Hackathon';

-- SELECT student.name, student.USN
-- FROM registration
-- JOIN student ON registration.USN = student.USN
-- JOIN event ON registration.event_id = event.event_id
-- WHERE event.name = 'Tech Talk on AI';

-- SELECT student.name, student.USN
-- FROM registration
-- JOIN student ON registration.USN = student.USN
-- JOIN event ON registration.event_id = event.event_id
-- WHERE event.name = 'Cybersecurity Workshop';

-- SELECT student.name, student.USN
-- FROM registration
-- JOIN student ON registration.USN = student.USN
-- JOIN event ON registration.event_id = event.event_id
-- WHERE event.name = 'Python Workshop';

-- SELECT student.name, student.USN
-- FROM registration
-- JOIN student ON registration.USN = student.USN
-- JOIN event ON registration.event_id = event.event_id
-- WHERE event.name = 'Data Science Seminar';
